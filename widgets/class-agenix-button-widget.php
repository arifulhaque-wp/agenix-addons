...
class Agenix_Button_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control('link', [
            ...
            'placeholder' => __( 'Enter your url here', 'agenix-addons' ),
            'default'     => [ 'url' => '#' ],
        ]);
        ...
        $this->add_control('icon_source', [
            ...
            'options' => [
                'none'      => [ 
                    'title' => __( 'None', 'agenix-addons' ), 'icon' => 'eicon-ban' 
                ],
                'svg'       => [ 
                    'title' => __( 'Upload SVG', 'agenix-addons' ), 'icon' => 'eicon-upload' 
                ],
                'elementor' => [ 
                    'title' => __( 'Elementor Icon', 'agenix-addons' ), 'icon' => 'eicon-circle' 
                ],
            ],
            'default' => 'none',
        ]);
        ...
        $this->add_control('icon', [
            'label'     => __( 'Icon Library', 'agenix-addons' ),
            'type'      => \Elementor\Controls_Manager::ICONS,
            'condition' => [ 'icon_source' => 'elementor' ],
        ]);

        $this->add_control('icon_svg', [
            'label'      => __( 'Upload SVG', 'agenix-addons' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'left'  => [
                        'title'=>__( 'Left', 'agenix-addons' ), 'icon'=>'eicon-h-align-left'
                    ],
                    'right'  => [
                        'title'=>__( 'Right', 'agenix-addons' ), 'icon'=>'eicon-h-align-right'
                    ],
                ],
    ...
    protected function render() {
        ...
        $this->add_render_attribute('button', 'class', 'agenix-button');
        ...
        // if ( $settings['icon_source'] === 'elementor' && ! empty( $settings['icon'] ) ) {
